...
// methodology/dex.md's two factors, and publishes `operationalState`. One
// market is registered to it — `AQUARIUS_POOLS`, iterated by the indexer's
// buildTargets the same way BLEND_POOLS is.
